...
<div class="mt-3 px-[11px] pr-[10px]">
    <div class="!z-5 relative flex flex-col rounded-[20px] bg-white bg-clip-border shadow-3xl shadow-shadow-500 dark:!bg-navy-800 dark:text-white dark:shadow-none">
        <div class="flex items-center justify-between p-6 pb-4">
            <div>
                <h4 class="text-xl font-bold text-navy-700 dark:text-white">Kelola Owner</h4>
                <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
                    Daftar owner yang menyewa sistem POS
                </p>
            </div>
                ...
                <thead>
                    <tr class="border-b border-gray-200 dark:border-white/10">
                        <th class="py-3 text-left">
                            <p class="text-sm font-bold text-gray-600 dark:text-white uppercase">Perusahaan</p>
                        </th>
                        <th class="py-3 text-left">
                            <p class="text-sm font-bold text-gray-600 dark:text-white uppercase">Pemilik</p>
                        </th>
                        <th class="py-3 text-left">
                            <p class="text-sm font-bold text-gray-600 dark:text-white uppercase">Kontak</p>
                        </th>
                        <th class="py-3 text-left">
                            <p class="text-sm font-bold text-gray-600 dark:text-white uppercase">Paket</p>
                        </th>
                        <th class="py-3 text-left">
                            <p class="text-sm font-bold text-gray-600 dark:text-white uppercase">Outlet</p>
                        </th>
                        <th class="py-3 text-left">
                            <p class="text-sm font-bold text-gray-600 dark:text-white uppercase">Expired</p>
                        </th>
                        <th class="py-3 text-left">
                ...
                <tbody>
                    ...
                    <tr class="border-b border-gray-100 dark:border-white/10 hover:bg-lightPrimary dark:hover:bg-navy-700 transition-colors">
                        <td class="py-4">
                            ...
                            <p class="text-xs text-gray-600 dark:text-gray-400">Sejak {{ date('d/m/Y', strtotime($owner['tanggal_daftar'])) }}</p>
                        </td>
                        <td class="py-4">
                        ...
                        <td class="py-4">
                            <p class="text-sm text-gray-600 dark:text-gray-400">{{ $owner['jumlah_outlet'] }} outlet</p>
                        </td>
                        <td class="py-4">
                            <p class="text-sm text-gray-600 dark:text-gray-400">{{ date('d/m/Y', strtotime($owner['tanggal_expired'])) }}</p>
                        </td>
                        <td class="py-4">
