...
<div class="p-3 md:pt-[100px] md:pl-3 md:pr-3">
    ...
    <div class="!z-5 relative mb-5 flex flex-col rounded-[20px] bg-white bg-clip-border shadow-3xl shadow-shadow-500 dark:!bg-navy-800 dark:text-white dark:shadow-none">
        <div class="p-6">
            <form method="GET" action="{{ route('reports.trade-in') }}" class="grid grid-cols-1 gap-4 md:grid-cols-5">
    ...
    <div class="!z-5 relative flex flex-col rounded-[20px] bg-white bg-clip-border shadow-3xl shadow-shadow-500 dark:!bg-navy-800 dark:text-white dark:shadow-none">
        <div class="p-6">
            <h5 class="text-xl font-bold text-navy-700 dark:text-white mb-4">Detail Tukar Tambah</h5>
