...
<div class="p-3 md:pt-[100px] md:pl-3 md:pr-3">
    ...
    <div class="!z-5 relative mb-5 flex flex-col rounded-[20px] bg-white bg-clip-border shadow-3xl shadow-shadow-500 dark:!bg-navy-800 dark:text-white dark:shadow-none">
        <div class="p-6">
            <form method="GET" action="{{ route('reports.stock') }}" class="grid grid-cols-1 gap-4 md:grid-cols-4">
                ...
                <div class="md:col-span-1">
                    <label class="block text-sm font-bold text-navy-700 dark:text-white mb-2">Filter</label>
                    <div class="flex items-center h-full">
                        <label class="flex items-center cursor-pointer">
                            <input type="checkbox" name="low_stock" value="1" {{ $lowStockOnly ? 'checked' : '' }} class="rounded border-gray-300 text-brand-500 shadow-sm focus:border-brand-300 focus:ring focus:ring-brand-200 focus:ring-opacity-50">
                            <span class="ml-2 text-sm text-navy-700 dark:text-white">Hanya stok menipis</span>
                        </label>
                    </div>
                </div>
    ...
    <div class="!z-5 relative flex flex-col rounded-[20px] bg-white bg-clip-border shadow-3xl shadow-shadow-500 dark:!bg-navy-800 dark:text-white dark:shadow-none">
        <div class="p-6">
            <h5 class="text-xl font-bold text-navy-700 dark:text-white mb-4">Detail Stok</h5>
