        ...
        <div class="overflow-x-auto px-6 pb-6">
            <table class="w-full">
                ...
                <tbody>
                    ...
                    <tr class="border-b border-gray-100 dark:border-white/10 hover:bg-lightPrimary dark:hover:bg-navy-700 transition-colors cursor-pointer" data-href="{{ route('produk.edit', $item->id) }}">
                        <td class="py-4">
