...
<div class="mt-3 px-[11px] pr-[10px]">
    ...
    <div class="!z-5 relative flex flex-col rounded-[20px] bg-white bg-clip-border shadow-3xl shadow-shadow-500 dark:!bg-navy-800 dark:text-white dark:shadow-none">
        ...
        <div class="border-b border-gray-200 dark:border-white/10 p-6">
            <h4 class="text-xl font-bold text-navy-700 dark:text-white">Add New Supplier</h4>
            <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">Create a new supplier contact</p>
        </div>
        ...
        <form action="{{ route('supplier.store') }}" method="POST" class="p-6">
            ...
            <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                ...
                <div>
                    ...
                    <input type="text" name="nomor_hp" value="{{ old('nomor_hp') }}" maxlength="45"
                ...
                <div>
                    ...
                    <input type="text" name="alamat" value="{{ old('alamat') }}" maxlength="255"
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="text" name="keterangan" value="{{ old('keterangan') }}" maxlength="255"
