...
<div class="mt-3 px-[11px] pr-[10px]">
    ...
    <div class="!z-5 relative flex flex-col rounded-[20px] bg-white bg-clip-border shadow-3xl shadow-shadow-500 dark:!bg-navy-800 dark:text-white dark:shadow-none p-6">
        ...
        <div class="mb-6 flex items-center justify-between border-b border-gray-200 dark:border-white/10 pb-4">
            <div>
                <h4 class="text-xl font-bold text-navy-700 dark:text-white">Edit Outgoing Transaction</h4>
                <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">Update purchase transaction details</p>
            </div>
        ...
        <div class="mb-6 flex flex-wrap items-center gap-3 rounded-xl bg-lightPrimary dark:bg-navy-900 p-4">
            ...
            <div class="flex items-center gap-2">
                ...
                <div>
                    ...
                    <p class="text-sm font-bold text-red-500">Rp {{ number_format($transaksi->total_harga, 0, ',', '.') }}</p>
                </div>
            </div>
            <div class="h-8 w-px bg-gray-300 dark:bg-white/10"></div>
            <div class="flex items-center gap-2">
                ...
                <div class="flex items-start gap-3">
                    ...
                    <div>
                        <p class="text-sm text-red-700 dark:text-red-400">
                            This is an outgoing purchase transaction. The invoice number cannot be changed.
                        </p>
                    </div>
                </div>
            </div>
