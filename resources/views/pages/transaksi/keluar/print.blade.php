...
<head>
    ...
    <title>Nota Pembelian #{{ $transaksi->invoice }}</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="receipt">
        ...
        <div class="header">
            ...
            <div class="type-badge">PEMBELIAN</div>
        </div>
        ...
        <div class="info-section">
            ...
            <div class="info-row">
                ...
                <span>{{ $transaksi->supplier->nama }}</span>
            </div>
            @endif
            <div class="info-row">
        ...
        <div class="footer">
            <p>*** TERIMA KASIH ***</p>
            <p>Nota Pembelian / Purchase Receipt</p>
    ...
    <script>
        ...
        sessionStorage.setItem('transaksi_success_message', 'Outgoing transaction has been successfully created');
        ...
        window.onafterprint = function() {
            if (!printDialogClosed) {
                ...
                // Redirect ke index
                window.location.replace('{{ route("transaksi.keluar.index") }}');
            }
        };
