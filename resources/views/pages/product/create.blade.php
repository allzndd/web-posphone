                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text"
                                    ...
                                    name="name" list="productNames" autocomplete="off" placeholder="Pilih atau ketik nama produk">
                            ...
                            <div class="form-group">
                                ...
                                <div id="cost-items">
                                    <div class="cost-row mb-2 d-flex">
                                        <input type="text" name="costs[0][description]" class="form-control mr-2" placeholder="Description">
                                        <input type="number" step="0.01" name="costs[0][amount]" class="form-control mr-2" placeholder="Amount">
                                        <button type="button" class="btn btn-danger btn-remove-cost" style="display:none">Remove</button>
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text"
                                    class="form-control @error('barre_health') is-invalid @enderror"
                                    name="barre_health" value="{{ old('barre_health') }}" placeholder="e.g. 85%">
                                @error('barre_health')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control @error('assessoris') is-invalid @enderror" name="assessoris" rows="3">{{ old('assessoris') }}</textarea>
                                @error('assessoris')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
