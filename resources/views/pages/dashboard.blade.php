        ...
        <div class="!z-5 relative flex flex-col rounded-[20px] bg-white bg-clip-border shadow-3xl shadow-shadow-500 dark:!bg-navy-800 dark:text-white dark:shadow-none p-6">
            ...
            <div class="space-y-3">
                ...
                <div class="p-3 bg-lightPrimary dark:bg-navy-700 rounded-xl">
                    ...
                    <a href="{{ route('produk.edit', $product) }}" class="w-full flex items-center justify-center px-3 py-2 bg-brand-500 text-white rounded-lg text-xs font-medium hover:bg-brand-600 transition-colors">
