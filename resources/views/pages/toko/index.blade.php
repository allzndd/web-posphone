            ...
            <div class="flex items-center gap-3">
                ...
                @else
                    <div class="relative inline-block group">
                        <button disabled
                           class="flex items-center gap-2 rounded-xl bg-gray-300 px-5 py-2.5 text-sm font-bold text-gray-500 cursor-not-allowed dark:bg-gray-700 dark:text-gray-400 opacity-60">
                            <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24" class="h-5 w-5" xmlns="http://www.w3.org/2000/svg">
                                <path fill="none" d="M0 0h24v24H0z"></path>
                                <path d="M19 13h-6v6h-2v-6H5v-2h6V5h2v6h6v2z"></path>
                            </svg>
                        ...
                        <div class="absolute right-0 bottom-full mb-2 w-64 bg-gray-800 dark:bg-gray-900 text-white text-xs rounded-lg p-3 opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none">
                            <p class="font-semibold mb-1">⚠️ Limit Reached</p>
                            <p>Paket Free Tier Anda hanya membolehkan 1 toko. Silakan upgrade paket untuk menambah lebih banyak toko.</p>
                        </div>
                    </div>
                @endif
                @endpermission
