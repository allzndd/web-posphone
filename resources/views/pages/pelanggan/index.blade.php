...
<div class="mt-3 px-[11px] pr-[10px]">
    ...
    <div class="!z-5 relative flex flex-col rounded-[20px] bg-white bg-clip-border shadow-3xl shadow-shadow-500 dark:!bg-navy-800 dark:text-white dark:shadow-none">
        ...
        <div class="flex items-center justify-between p-6 pb-4">
            <div>
                <h4 class="text-xl font-bold text-navy-700 dark:text-white">Customers</h4>
            ...
            <div class="flex items-center gap-3">
                ...
                <form method="GET" action="{{ route('pelanggan.index') }}" class="relative">
                    <div class="flex items-center rounded-xl border border-gray-200 dark:border-white/10 bg-lightPrimary dark:bg-navy-900 px-4 py-2">
                        ...
                        <input type="text" name="nama" value="{{ request('nama') }}" placeholder="Search customers..." 
        ...
        <div class="overflow-x-auto px-6 pb-6">
            <table class="w-full">
                <thead>
                    <tr class="border-b border-gray-200 dark:border-white/10">
                        <th class="py-3 text-left">
                            <p class="text-sm font-bold text-gray-600 dark:text-white uppercase">Customer Name</p>
                        </th>
                        <th class="py-3 text-left">
                ...
                <tbody>
                    ...
                    <tr class="border-b border-gray-100 dark:border-white/10 hover:bg-lightPrimary dark:hover:bg-navy-700 transition-colors cursor-pointer" data-href="{{ route('pelanggan.edit', $item->id) }}">
                        <td class="py-4">
                    ...
                    <tr>
                        <td colspan="5" class="py-12 text-center">
                            <div class="flex flex-col items-center justify-center">
                                ...
                                <p class="text-gray-400 dark:text-gray-500 text-sm mt-1">Start by creating your first customer</p>
                            </div>
                        </td>
                    </tr>
                    @endforelse
