...
@section('title', 'Register M iPhone Group')
    ...
    <div class="mt-16 mb-16 flex h-full w-full items-center justify-center px-2 md:mx-0 md:px-0 lg:mb-10 lg:items-center lg:justify-start">
        ...
        <div class="mt-[10vh] w-full max-w-full flex-col items-center md:pl-4 lg:pl-0 xl:max-w-[420px]">
            ...
            <div class="mb-6 flex items-center gap-3">
                ...
                <p class="text-base text-gray-600">Join Us</p>
                <div class="h-px w-full bg-gray-200"></div>
            </div>
            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                <!-- Name -->
                <div class="mb-3">
                    <label for="name" class="ml-1.5 text-sm font-medium text-navy-700">
                        Name*
                    </label>
                    <input 
                        id="name" 
                        ...
                        value="{{ old('name') }}"
                        class="mt-2 flex h-12 w-full items-center justify-center rounded-xl border bg-white/0 p-3 text-sm outline-none @error('name') border-red-500 text-red-500 placeholder:text-red-500 @else border-gray-200 @enderror"
                        autofocus
                    >
                    @error('name')
                ...
                <div class="mb-3">
                    <label for="password_confirmation" class="ml-1.5 text-sm font-medium text-navy-700">
                        Password Confirmation*
                    </label>
                    <div class="relative">
                        <input 
                            ...
                            autocomplete="new-password"
                            class="mt-2 flex h-12 w-full items-center justify-center rounded-xl border bg-white/0 p-3 pr-12 text-sm outline-none @error('password_confirmation') border-red-500 text-red-500 placeholder:text-red-500 @else border-gray-200 @enderror"
                        >
                        <button 
                            type="button" 
                            class="toggle-password absolute right-3 top-1/2 -translate-y-1/2 mt-1 text-gray-400 hover:text-gray-600"
                ...
                <button 
                    type="submit" 
                    class="mt-4 w-full rounded-xl bg-brand-500 py-3 text-base font-medium text-white transition duration-200 hover:bg-brand-600 active:bg-brand-700"
                >
                    Create Account
                </button>
                ...
                <div class="mt-4">
                    ...
                    <a href="{{ route('login') }}" class="ml-1 text-sm font-medium text-brand-500 hover:text-brand-600">
                        Sign In
                    </a>
                </div>
            </form>
