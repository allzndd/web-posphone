...
<div class="mt-3 px-[11px] pr-[10px]">
    <div class="!z-5 relative flex flex-col rounded-[20px] bg-white bg-clip-border shadow-3xl shadow-shadow-500 dark:!bg-navy-800 dark:text-white dark:shadow-none">
        <div class="flex items-center justify-between p-6 pb-4">
            <div>
                <h4 class="text-xl font-bold text-navy-700 dark:text-white">Pembayaran Subscription</h4>
                <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
                    Kelola pembayaran subscription owner yang menyewa sistem
                </p>
            </div>
            ...
            <table class="w-full">
                <thead>
                    <tr class="border-b border-gray-200 dark:border-white/10">
                        ...
                        <th class="py-3 text-left">
                            <p class="text-sm font-bold text-gray-600 dark:text-white uppercase">Periode</p>
                        </th>
                        <th class="py-3 text-left">
                ...
                <tbody>
                    ...
                    <tr class="border-b border-gray-100 dark:border-white/10 hover:bg-lightPrimary dark:hover:bg-navy-700 transition-colors">
                        <td class="py-4">
                            <p class="text-sm text-gray-600 dark:text-gray-400">{{ date('d/m/Y', strtotime($item['tanggal'])) }}</p>
                        </td>
                        <td class="py-4">
                            <p class="text-sm font-bold text-navy-700 dark:text-white">{{ $item['owner'] }}</p>
                        </td>
                        <td class="py-4">
