...
{
    /**
     * Display a listing of all transactions (incoming and outgoing).
     */
    public function index(Request $request)
    {
        try {
            ...
            return response()->json([
                'success' => true,
                'message' => 'Data seluruh transaksi berhasil diambil',
    ...
    public function summary(Request $request)
    {
        try {
            ...
            return response()->json([
                'success' => false,
                'message' => 'Gagal mengambil summary transaksi: ' . $e->getMessage(),
            ], 500);
        }
    }

    /**
     * Apply common filters for transactions.
     */
